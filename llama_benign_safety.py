...
NEW_MODEL_NAME = "llama-2-7b-chat-benign-safety"
...
def merge_tokenized_data(safety_data, benign_data):
    safety_input_ids = safety_data["train"]["input_ids"]
    safety_attention_mask = safety_data["train"]["attention_mask"]

    benign_input_ids = benign_data["train"]["input_ids"]
    benign_attention_mask = benign_data["train"]["attention_mask"]

    merged_input_ids = safety_input_ids + benign_input_ids
    merged_attention_mask = safety_attention_mask + benign_attention_mask
...
if __name__ == "__main__":
    ...
    merged_data = merge_tokenized_data(safety_data, benign_data)
