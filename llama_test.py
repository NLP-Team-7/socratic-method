...
if __name__ == "__main__":
    ...
    # outputs = model.generate(inputs.input_ids.cuda(), max_length=100, num_beams=5, early_stopping=True)
    # outputs = model.generate(input_ids=inputs.input_ids.cuda(), max_new_tokens=100, do_sample=True, top_p=0.9, temperature=0.9)
